---
id: cf7-mailchimp
title: Contact Form 7 Integration With Mailchimp
...
2. Now select Contact Form 7 that you want to integrate with Mailchimp.
...
3. Select the form name from the Drop-Down list that you want to integrate with Mailchimp. And click on the **“Next” button.** And select **Mailchimp**.
   ...
   <Image src="mailchimp/_select-form" alt="Mailchimp" w="1020" h="350" />
