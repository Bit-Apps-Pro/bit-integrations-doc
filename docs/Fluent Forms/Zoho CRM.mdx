---
id: fluentf-zohocrm
title: Fluent Forms Integration With Zoho CRM
sidebar_label:  Zoho CRM
slug: /integrations/fluentforms-zohocrm
---
...
2. Now select Fluent Forms that you want to integrate with Zoho CRM.
...
3.	Select the form name from the Drop-Down list that you want to integrate with Zoho CRM. And click on the **“Next” button**. And select **Zoho CRM.**
 <Image src="zoho-crm/_fluent-form" alt="Zoho CRM" w="1020" h="350" />
...
## Related List
1. You can send data Zoho CRM related list from Fluent Forms. Select the required related list module and layout from the drop-down provided. Then map the mandatory field. To map more fields, click on the (+).
