...
2. Now select Ninja Form that you want to integrate with Zoho CRM.
...
3.	Select the form name from the Drop-Down list that you want to integrate with Zoho CRM. And click on the **“Next” button**. And select **Zoho CRM.**
 <Image src="Zoho CRM/ninja-form" alt="Zoho CRM" w="1020" h="350" />
...
## Related List
1. You can send data Zoho CRM related list from Ninja Form. Select the required related list module and layout from the drop-down provided. Then map the mandatory field. To map more fields, click on the (+).
