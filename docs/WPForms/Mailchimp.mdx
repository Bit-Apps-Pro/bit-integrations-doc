---
id: wpf-mailchimp
title: WPForms Integration With Mailchimp
sidebar_label: Mailchimp
slug: /integrations/wpforms-mailchimp
---
...
2. Now select WPForms that you want to integrate with Mailchimp.
...
3. Select the form name from the Drop-Down list that you want to integrate with Mailchimp. And click on the **“Next” button.** And select **Mailchimp**.
   ...
   <Image src="mailchimp/_wp-forms" alt="Mailchimp" w="1020" h="350" />
