 ...
 **B. Template:** By selecting this option, You can send message, that you have already created. Just copy the template name paste it into Template option in integrations setting. You need to map the field before put the template name.
