---
id: eform-mailchimp
title: eForm Integration With Mailchimp
sidebar_label: Mailchimp
slug: /integrations/eform-mailchimp
---
...
2. Now select eForm that you want to integrate with Mailchimp.
...
3. Select the form name from the Drop-Down list that you want to integrate with Mailchimp. And click on the **“Next” button.** And select **Mailchimp**.
   ...
   <Image src="mailchimp/_e-form" alt="Mailchimp" w="1020" h="350" />
