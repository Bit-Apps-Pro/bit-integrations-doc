---
id: cart-flow
title: Select Cart Flow As A trigger
sidebar_label: Cart Flow
slug: /trigger/cart-flow
---

import Image from "@site/src/components/Image";
import Feedback from "@site/src/components/Feedback";

> **Note: Cart Flow is available in the free and pro versions.**

1. At First, Open your Bit Integration Dashboard and create an integrations by clicking the **_“Create Integration”_** button.

   <Image src="trigger/_create-integrations" alt="Cart Flow" w="1020" h="350" />

2. Now select the **Cart Flow** that you want to integrate with Bit Integrations **Actions**.

   <Image src="trigger/cart-flow/select-trigger" alt="Cart Flow" w="1020" h="350" />
...
3. Select the task from the Drop-Down list that you want to integrate with Bit Integrations **Actions**. And click on the **“Next”** button.
   ...
   <Image src="trigger/cart-flow/select-form-or-task-name" alt="Cart Flow" w="1020" h="350"/>
