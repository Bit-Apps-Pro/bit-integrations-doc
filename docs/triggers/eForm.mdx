---
id: eform
title: Select eForm As A trigger
sidebar_label: eForm
slug: /trigger/trigger-wpeform
---

import Image from "@site/src/components/Image";
import Feedback from "@site/src/components/Feedback";

> **Note: eForm is available in the free and pro versions.**

1. At First, Open your Bit Integration Dashboard and create an integrations by clicking the **_“Create Integration”_** button.

   <Image
     src="trigger/eform/_create-integrations"
     alt="Active-Campaign"
     w="1020"
     h="350"
   />

2. Now select the **eForm** that you want to integrate with Bit Integrations **Actions**.

   <Image
     src="trigger/eform/_select-trigger"
     alt="Active-Campaign"
     w="1020"
     h="350"
   />
